...
## [Unreleased]
- Добавлено решение для ошибки `externally-managed-environment` (PEP 668) в документацию.
- Расширен раздел "Быстрая установка" с подробными инструкциями для Debian 12+ (виртуальное окружение).
- Обновлены обе версии документации (русская и английская).
